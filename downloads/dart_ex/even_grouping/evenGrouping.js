// Generated by dart2js (fast startup emitter, strong), the Dart to JavaScript compiler version: 2.8.0-edge.c0ca187f2699fb7f46fccb8c664a2ba3a0958fce.
...
(function dartProgram() {
  ...
  H = {JS_CONST: function JS_CONST() {
      ...
      if (bounds != null) {
        ...
        for (typeParametersText = "<", typeSep = "", i = 0; i < boundsLength; ++i, typeSep = _s2_) {
          ...
          if (t1 !== 5)
            if (t1 !== 2)
              if (t1 !== 3)
                t1 = t1 === 9 && boundRti._primary === "Object" || t1 === 4;
              else
                t1 = true;
            else
              t1 = true;
    ...
    _Universe__lookupTerminalRti: function(universe, kind, canonicalRecipe) {
      ...
      if (probe != null)
        return probe;
      rti = new H.Rti(_null, _null, _null, _null);
      rti._kind = kind;
    ...
    _Universe__lookupBindingRti: function(universe, base, $arguments) {
      var newBase, newArguments, s, probe, rti, _null = null;
      if (base._kind === 10) {
    ...
    _isSubtype: function(universe, s, sEnv, t, tEnv) {
      ...
      t1 = s._kind;
      if (t1 === 9 && s._primary === "Null")
        return true;
      t2 = t._kind;
      if (t2 === 8) {
        tTypeArgument = t._primary;
        if (t1 === 8)
          return H._isSubtype(universe, s._primary, sEnv, tTypeArgument, tEnv);
        else if (H._isSubtype(universe, s, sEnv, tTypeArgument, tEnv))
          return true;
        else
          return H._isSubtypeOfInterface(universe, s, sEnv, "Future", [tTypeArgument], tEnv);
      }
      if (t1 === 13)
        return H._isSubtype(universe, sEnv[s._primary], sEnv, t, tEnv);
      if (t2 === 13)
        return false;
      if (t2 === 12) {
        if (H.isJsFunctionType(s))
          return true;
        return H._isGenericFunctionSubtype(universe, s, sEnv, t, tEnv);
      }
      if (t2 === 11) {
        if (H.isJsFunctionType(s))
          return true;
      ...
      if (t1 === 11 || t1 === 12)
        return t2 === 9 && t._primary === "Function";
      return H._isSubtypeOfInterface(universe, s, sEnv, t._primary, t._rest, tEnv);
    },
    _isGenericFunctionSubtype: function(universe, s, sEnv, t, tEnv) {
      var sBounds, tBounds;
      if (s._kind !== 12)
        return false;
      sBounds = s._rest;
      tBounds = t._rest;
      if (!H.typesEqual(sBounds, tBounds))
        return false;
    ...
    _isSubtypeOfInterface: function(universe, s, sEnv, tName, tArgs, tEnv) {
      var sArgs, $length, i, t1, t2, rule, supertypeArgs,
        sName = s._primary;
      if (sName === tName) {
        sArgs = s._rest;
        $length = sArgs.length;
    ...
    typeEqual: function(s, t) {
      var sKind, t1, t2;
      if (s === t)
        return true;
      if (H.isTopType(s))
        return H.isTopType(t);
      sKind = s._kind;
      if (sKind !== t._kind)
        return false;
      switch (sKind) {
        ...
        case 7:
        case 8:
          return H.typeEqual(s._primary, t._primary);
        case 9:
          if (s._primary !== t._primary)
            return false;
          return H.typesEqual(s._rest, t._rest);
        case 10:
          return H.typeEqual(s._primary, t._primary) && H.typesEqual(s._rest, t._rest);
        case 11:
          if (H.typeEqual(s._primary, t._primary)) {
            t1 = s._rest;
            t2 = t._rest;
            t1 = H.typesEqual(t1._requiredPositional, t2._requiredPositional) && H.typesEqual(t1._optionalPositional, t2._optionalPositional) && H.namedTypesEqual(t1._optionalNamed, t2._optionalNamed);
          } else
            t1 = false;
          return t1;
        case 12:
    ...
    typesEqual: function(sArray, tArray) {
      var i,
        sLength = sArray.length;
      if (sLength !== tArray.length)
        return false;
      for (i = 0; i < sLength; ++i)
        if (!H.typeEqual(sArray[i], tArray[i]))
          return false;
      return true;
    },
    namedTypesEqual: function(sArray, tArray) {
      var i, t1,
        sLength = sArray.length;
      if (sLength !== tArray.length)
        return false;
      for (i = 0; i < sLength; i += 2) {
        if (sArray[i] !== tArray[i])
          return false;
        t1 = i + 1;
        if (!H.typeEqual(sArray[t1], tArray[t1]))
          return false;
      }
      return true;
    },
    isTopType: function(t) {
      ...
      if (t1 !== 5)
        if (t1 !== 2)
          if (t1 !== 3)
            t1 = t1 === 9 && t._primary === "Object" || t1 === 4;
          else
            t1 = true;
        else
          t1 = true;
    ...
    isJsFunctionType: function(t) {
      return t._kind === 9 && t._primary === "JavaScriptFunction";
    },
    ...
    Rti: function Rti(t0, t1, t2, t3) {
      var _ = this;
      _._as = t0;
      _._check = t1;
      _._is = t2;
      _._precomputed1 = t3;
      _._cachedRuntimeType = _._specializedTestResource = null;
      _._kind = 0;
  ...
  W = {
    Element_Element$html: function(html, treeSanitizer, validator) {
      ...
      return type$.Element._check(result);
    },
    ...
    HttpRequest_request: function(url, onProgress, withCredentials) {
      ...
      t3 = t2._check(new W.HttpRequest_request_closure(xhr, completer));
      type$.void_Function._check(null);
      t4 = type$.ProgressEvent;
      W._EventStreamSubscription$(xhr, "load", t3, false, t4);
      W._EventStreamSubscription$(xhr, "error", t2._check(completer.get$completeError()), false, t4);
      xhr.send();
      return t1;
    },
  ...
  N = {
    main: function() {
      var t1 = J.get$onClick$x(document.querySelector("#submit")),
        t2 = t1.$ti,
        t3 = t2._eval$1("~(1)")._check(new N.main_closure());
      type$.void_Function._check(null);
    ...
    grouping: function() {
      ...
      t1.gpList = [];
      t1.numList = [];
      W.HttpRequest_getString(t2).then$1$1(new N.grouping_closure(t1, [], "wcmj2020"), type$.Null);
    },
  ...
  P._Future__asyncComplete_closure.prototype = {
    call$0: function() {
      var t1 = this.$this,
        t2 = t1.$ti._precomputed1._check(this.value),
  ...
  P.Stream.prototype = {
    get$length: function(_) {
      ...
      t3 = t2._eval$1("~(1)")._check(new P.Stream_length_closure(t1, _this));
      type$.void_Function._check(new P.Stream_length_closure0(t1, future));
  ...
  P.Stream_length_closure.prototype = {
    call$1: function(_) {
      H._instanceType(this.$this)._precomputed1._check(_);
      ++this._box_0.count;
    },
    $signature: function() {
  ...
  W.HttpRequest_getString_closure.prototype = {
    call$1: function(xhr) {
      return type$.HttpRequest._check(xhr).responseText;
    },
    $signature: 16
  };
  ...
  W._ElementAttributeMap.prototype = {
    $index: function(_, key) {
      return this._html$_element.getAttribute(H._checkStringNullable(key));
    },
    get$length: function(_) {
  ...
  W._ValidatingTreeSanitizer_sanitizeTree_walk.prototype = {
    call$2: function(node, $parent) {
      var child, nextChild, t2, exception, t3, t4,
        t1 = this.$this;
      ...
      for (t1 = type$.Node, t2 = node == null; null != child;) {
        nextChild = null;
        try {
  ...
  N.grouping_closure.prototype = {
    call$1: function(resp) {
      ...
      for (t2 = numList.length, t3 = this.group, _i = 0; _i < numList.length; numList.length === t2 || (0, H.throwConcurrentModificationError)(numList), ++_i) {
        ...
        t4 = $.$get$output();
        t4.textContent = J.$add$ansx(t4.textContent, "group " + t1.gth + " \u6709 " + J.toString$0$(t1.i) + " \u4eba: \n");
        t1.gpList = [];
        t1.j = 0;
        t4 = 0;
        while (true) {
          ...
          t5.textContent = J.$add$ansx(t6, J.$add$ansx(studList[t7], "\n"));
          t7 = t1.gpList;
          t6 = t1.j;
          t5 = t1.inc;
          if (typeof t6 !== "number")
        ...
        t5._eval$1("int(1,1)")._check(null);
  ...
  var init = {typeUniverse: {eC: new Map(), tR: {}, eT: {}, tPV: {}, sEA: []}, mangledGlobalNames: {int: "int", double: "double", num: "num", String: "String", bool: "bool", Null: "Null", List: "List"}, mangledNames: {}, getTypeFromName: getGlobalFromName, metadata: [], types: ["Null()", "~()", "~(~())", "@(@)", "Null(@)", "bool(NodeValidator)", "bool(String)", "bool(Element,String,String,_Html5NodeValidator)", "@(@,String)", "@(String)", "Null(~())", "~(Object[StackTrace])", "Null(@[StackTrace])", "_Future<@>(@)", "Null(@,@)", "bool(Node)", "String(HttpRequest)", "Null(ProgressEvent)", "@(Event)", "String(String)", "~(Node,Node)", "@(MouseEvent)", "Null(String)", "int(@,@)"], interceptorsByTag: null, leafTags: null};
  H._Universe_addRules(init.typeUniverse, JSON.parse('{"AbortPaymentEvent":"Event","ExtendableEvent":"Event","AElement":"SvgElement","GraphicsElement":"SvgElement","_ResourceProgressEvent":"ProgressEvent","AudioElement":"HtmlElement","MediaElement":"HtmlElement","HtmlDocument":"Node","Document":"Node","Window":"EventTarget","PointerEvent":"MouseEvent","CompositionEvent":"UIEvent","CDataSection":"CharacterData","Text":"CharacterData","JSBool":{"bool":[]},"JSNull":{"Null":[]},"JavaScriptFunction":{"Function":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"ArrayIterator":{"Iterator":["1"]},"JSNumber":{"num":[],"Comparable":["num"]},"JSInt":{"int":[],"num":[],"Comparable":["num"]},"JSDouble":{"num":[],"Comparable":["num"]},"JSString":{"String":[],"Pattern":[],"Comparable":["String"]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"Iterable":["1"]},"ListIterator":{"Iterator":["1"]},"MappedListIterable":{"ListIterable":["2"],"Iterable":["2"],"ListIterable.E":"2","Iterable.E":"2"},"WhereIterable":{"Iterable":["1"],"Iterable.E":"1"},"WhereIterator":{"Iterator":["1"]},"NullError":{"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"JsLinkedHashMap":{"MapMixin":["1","2"],"Map":["1","2"],"MapMixin.K":"1","MapMixin.V":"2"},"LinkedHashMapKeyIterable":{"Iterable":["1"],"Iterable.E":"1"},"LinkedHashMapKeyIterator":{"Iterator":["1"]},"_Error":{"Error":[]},"_CastError":{"Error":[]},"_TypeError":{"Error":[]},"_AsyncCompleter":{"_Completer":["1"]},"_Future":{"Future":["1"]},"AsyncError":{"Error":[]},"_Zone":{"Zone":[]},"_RootZone":{"Zone":[]},"_LinkedHashSet":{"_SetBase":["1"],"Set":["1"],"Iterable":["1"]},"_LinkedHashSetIterator":{"Iterator":["1"]},"ListBase":{"ListMixin":["1"],"List":["1"],"Iterable":["1"]},"MapBase":{"MapMixin":["1","2"],"Map":["1","2"]},"MapMixin":{"Map":["1","2"]},"_SetBase":{"Set":["1"],"Iterable":["1"]},"double":{"num":[],"Comparable":["num"]},"AssertionError":{"Error":[]},"NullThrownError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"OutOfMemoryError":{"Error":[]},"StackOverflowError":{"Error":[]},"CyclicInitializationError":{"Error":[]},"int":{"num":[],"Comparable":["num"]},"List":{"Iterable":["1"]},"num":{"Comparable":["num"]},"String":{"Pattern":[],"Comparable":["String"]},"HtmlElement":{"Element":[],"Node":[],"EventTarget":[]},"AnchorElement":{"Element":[],"Node":[],"EventTarget":[]},"AreaElement":{"Element":[],"Node":[],"EventTarget":[]},"BaseElement":{"Element":[],"Node":[],"EventTarget":[]},"BodyElement":{"Element":[],"Node":[],"EventTarget":[]},"CharacterData":{"Node":[],"EventTarget":[]},"Element":{"Node":[],"EventTarget":[]},"FormElement":{"Element":[],"Node":[],"EventTarget":[]},"HttpRequest":{"EventTarget":[]},"HttpRequestEventTarget":{"EventTarget":[]},"InputElement":{"Element":[],"Node":[],"EventTarget":[]},"MouseEvent":{"Event":[]},"_ChildNodeListLazy":{"ListMixin":["Node"],"List":["Node"],"Iterable":["Node"],"ListMixin.E":"Node"},"Node":{"EventTarget":[]},"NodeList":{"ImmutableListMixin":["Node"],"ListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListMixin.E":"Node","ImmutableListMixin.E":"Node"},"ProgressEvent":{"Event":[]},"SelectElement":{"Element":[],"Node":[],"EventTarget":[]},"TableElement":{"Element":[],"Node":[],"EventTarget":[]},"TableRowElement":{"Element":[],"Node":[],"EventTarget":[]},"TableSectionElement":{"Element":[],"Node":[],"EventTarget":[]},"TemplateElement":{"Element":[],"Node":[],"EventTarget":[]},"TextAreaElement":{"Element":[],"Node":[],"EventTarget":[]},"UIEvent":{"Event":[]},"_Attr":{"Node":[],"EventTarget":[]},"_NamedNodeMap":{"ImmutableListMixin":["Node"],"ListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ListMixin.E":"Node","ImmutableListMixin.E":"Node"},"_AttributeMap":{"MapMixin":["String","String"],"Map":["String","String"]},"_ElementAttributeMap":{"MapMixin":["String","String"],"Map":["String","String"],"MapMixin.K":"String","MapMixin.V":"String"},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]},"_Html5NodeValidator":{"NodeValidator":[]},"NodeValidatorBuilder":{"NodeValidator":[]},"_SimpleNodeValidator":{"NodeValidator":[]},"_TemplatingNodeValidator":{"NodeValidator":[]},"_SvgNodeValidator":{"NodeValidator":[]},"FixedSizeListIterator":{"Iterator":["1"]},"_SameOriginUriPolicy":{"UriPolicy":[]},"_ValidatingTreeSanitizer":{"NodeTreeSanitizer":[]},"_JSRandom":{"Random":[]},"ScriptElement0":{"SvgElement":[],"Element":[],"Node":[],"EventTarget":[]},"SvgElement":{"Element":[],"Node":[],"EventTarget":[]}}'));
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "studListUrl", "$get$studListUrl", function() {
      return H.findType("InputElement")._check(W.querySelector("#studListUrl"));
    });
    _lazy($, "output", "$get$output", function() {
      return H.findType("TextAreaElement")._check(W.querySelector("#output"));
    });
  })();
...
//# sourceMappingURL=evenGrouping.js.map
