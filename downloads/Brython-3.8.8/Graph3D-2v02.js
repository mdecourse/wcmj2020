...
(function(){
  ...
  {
    const col = new RGBAColor(ballColor),
          rVal = col.r,
          gVal = col.g,
          bVal = col.b,
          d = 1.5*rad,
    ...
    function RadialGradient(p1x, p1y, r1, p2x, p2y, r2)
    {
    ...
    brightGrad.addColorStop(0.7, "rgba(255,255,255,0.05)");
    ...
    const ball = new Path3D(["M", 0,0,0, "l",0.01,0,0], {
          strokeColor: ballGrad, 
          lineWidthWC: d,
          lineCap: "round"} ); 
    const shade = new Path3D(["M", 0,0,0, "l",0.01,0,0], {
          strokeColor:shadowGrad, 
          lineWidthWC: d,
          lineCap: "round"});
    const ballHilite = new Path3D(["M", 0,0,0, "l",0.01,0,0], {
          strokeColor: brightGrad, 
          lineWidthWC: d,
          lineCap: "round"});

    return new Group3D(ball, shade, ballHilite);
  }          
